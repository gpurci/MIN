...
class MutateChoice(GAChoiceBase):
    """
    """
    def __init__(self, *objects, p_select=None, scores=None):
        super().__init__(*objects, p_select=p_select, scores=scores, name="MutateChoice", inherit_class="MutateBase")

    def __call__(self, parent1, parent2, offspring):
        cond = np.random.choice(self._range, size=None, p=self_p_select)
        return self._objects[cond](parent1, parent2, offspring)
