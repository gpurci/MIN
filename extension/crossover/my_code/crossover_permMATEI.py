...
class CrossoverPerm(RootGA):
    """
    Crossover operators for permutation chromosomes (TSP).
    Methods copied unchanged from manager Crossover.
    """
    ...
    def __str__(self):
        return f"CrossoverPerm(method={self.__method}, configs={self.__configs})"

    def help(self):
        return """CrossoverPerm:
...
"""
    ...
    def crossoverAbstract(self, *a, **kw):
        raise NameError(f"Lipseste metoda '{self.__method}' pentru CrossoverPerm")

    # ============================================================
    # ---- UNCHANGED CROSSOVERS FROM MANAGER ---------------------
    # ============================================================
