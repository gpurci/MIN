...
class MetricsTTPV1(MetricsBase):
    ...
    # Liniar ---------------------
    def __computeIndividSpeed(self, individ, *args, v_min=0.1, v_max=1, W=2000, alpha=0.01, R=1):
        # unpack chromosomes
        ...
        for i in range(self.GENOME_LENGTH):
            ...
            speeds[i] = self.computeSpeed(v_max, v_min, Wcur, W)
        return speeds
    ...
    def metricsTTPLiniar(self, genomics, **kw):
        ...
        for idx, individ in enumerate(genomics.population(), 0):
            speeds = self.__computeIndividSpeed(individ, *args, **kw)
    ...
    # utils ++++++++++++++++++++++++++++++++++++++++++++++
    def computeSpeed(self, v_max, v_min, Wcur, Wmax):
        """
