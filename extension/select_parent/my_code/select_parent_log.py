...
class SelectParentLog(SelectParentBase):
    """
    Clasa 'SelectParentLog', ofera doar metode pentru a selecta unul din parinti in calitate de parinte 1 sau 2
    ...
    def __init__(self, method, **configs):
        super().__init__(method, name="SelectParentLog", **configs)
    ...
    def startEpoch(self, fitness_values):
        ...
        fitness_values = np.log(fitness_values+1e-7)
