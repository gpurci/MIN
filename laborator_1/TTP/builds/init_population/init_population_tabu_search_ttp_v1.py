...
class InitPopulationTabuSearchV1(InitPopulationBase):
    """
    Clasa 'InitPopulationTabuSearchV1', 
    """
    def __init__(self, method, dataset_man=None, **configs):
        super().__init__(method, name="InitPopulationTabuSearchV1", **configs)
    ...
    def help(self):
        info = """InitPopulationTabuSearchV1:
